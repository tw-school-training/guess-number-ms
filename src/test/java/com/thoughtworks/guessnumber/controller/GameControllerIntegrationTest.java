...
public class GameControllerIntegrationTest {
    ...
    public void should_return_game_record_response_when_guess() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/guess").queryParam("user-answer", "1234"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.ticket", Matchers.notNullValue()))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.guessHistory", Matchers.hasSize(1)))
                .andExpect(MockMvcResultMatchers.jsonPath("$.guessHistory[0].userGuess", Matchers.notNullValue()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.guessHistory[0].compareResult", Matchers.notNullValue()));
    }
}
